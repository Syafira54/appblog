  ...
  <header class="border-bottom lh-1 py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
        ...
        <a class="btn btn-sm btn-outline-secondary" href="<?php echo e(site_url('login')); ?>">Login</a>
      </div>
    </div>
  </header>
...
<?php /**PATH D:\pemweb\appblog\application\views/template/frontend/theme.blade.php ENDPATH**/ ?>