    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-body-tertiary sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?php echo e(site_url('backend/dashboard')); ?>">
...
<?php /**PATH D:\pemweb\appblog\application\views/template/backend/theme.blade.php ENDPATH**/ ?>